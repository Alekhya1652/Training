interface person {
  ...
  let p: person = {
    name: "alekhya",
    age: 21,
    email: "alekhyasanapala2002@gmail.com",
  };
  ...
  console.log("capitalized version of alekhya is", capitalize("alekhya"));
